...
void APuzzlePlatformsCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ActivatePauseMenu", IE_Pressed, this, &APuzzlePlatformsCharacter::PauseMenu);
}
...
void APuzzlePlatformsCharacter::PauseMenu()
{
	UPuzzlePlatformsGameInstance* PPGameInstance = Cast<UPuzzlePlatformsGameInstance>(this->GetGameInstance());
	if (PPGameInstance)
	{
